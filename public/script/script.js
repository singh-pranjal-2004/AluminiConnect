...
function loaderAnimation() {
  ...
  // Initially show the loader and hide everything else
  body.classList.add("hidden-loader");

  setTimeout(function () {
    // Hide the loader and show the rest of the content
    loader.style.top = "-100%";
    body.classList.remove("hidden-loader");
  }, 4200); // Match this duration with the animation duration
}
